...
These rules apply to ALL work unless the user explicitly opts out. Ever work with UI/UX the work with the defined design system located in .agent/skills/design-system/SKILL.md
Prefer `pnpm` than `npm`!
